...
<img width="100%" src="https://capsule-render.vercel.app/api?type=wahab&color=0:39ff14,45:a855f7,100:22d3ee&height=230&section=header&text=WAHAB%20%E2%9C%98%20MUSIC&fontSize=56&fontColor=ffffff&fontAlignY=34&desc=The%20Deadliest%20Telegram%20Music%20Bot&descAlignY=55&descSize=18&animation=twinkling" alt="WAHAB MUSIC animated banner"/>

<img src="https://te.legra.ph/file/7d9c0fec898bbee09ba95.jpg" width="320" height="auto" alt="Wahab Music">

<br>

<a href="https://github.com/wahabbolteop/WahabMusic"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&pause=1000&color=7DFF00&center=true&vCenter=true&multiline=true&repeat=true&width=740&height=78&lines=Instant+Play+%E2%9A%A1+%C2%B7+4K+Video+Calls+%F0%9F%8E%AC+%C2%B7+Premium+Emoji+UI+%F0%9F%92%8E;PO-Token-Hardened+YouTube+Pipeline+%F0%9F%9B%A1%EF%B8%8F;Multi-Assistant+Fleet+%F0%9F%91%A5+%C2%B7+WARP+Proxy+Routing+%F0%9F%8C%90;Non-Stop+Playback+%E2%80%94+No+Waiting+%2C+Just+Play+%F0%9F%8E%A7" alt="Typing SVG"/></a>
...
[![Stars](https://img.shields.io/github/stars/wahabbolteop/WahabMusic?color=7dff00&logo=github&logoColor=7dff00&style=for-the-badge)](https://github.com/wahabbolteop/WahabMusic/stargazers)
[![Forks](https://img.shields.io/github/forks/wahabbolteop/WahabMusic?color=a855f7&logo=github&logoColor=a855f7&style=for-the-badge)](https://github.com/wahabbolteop/WahabMusic/network/members)
[![Issues](https://img.shields.io/github/issues/wahabbolteop/WahabMusic?color=06b6d4&logo=github&logoColor=06b6d4&style=for-the-badge)](https://github.com/wahabbolteop/WahabMusic/issues)
...
[![Last Commit](https://img.shields.io/github/last-commit/wahabbolteop/WahabMusic?color=22d3ee&logo=github&logoColor=22d3ee&style=for-the-badge)](https://github.com/wahabbolteop/WahabMusic/commits/main)
[![Repo Size](https://img.shields.io/github/repo-size/wahabbolteop/WahabMusic?color=ef4444&logo=github&logoColor=ef4444&style=for-the-badge)](https://github.com/wahabbolteop/WahabMusic)
[![Views](https://komarev.com/ghpvc/?username=wahabbolteop&label=PROFILE+VIEWS&color=a855f7&style=for-the-badge)](https://github.com/wahabbolteop/WahabMusic)

<br>

<a href="https://t.me/wahab_chatting"><img src="https://img.shields.io/badge/%F0%9F%91%A5%20Support%20Group-0ea5e9?style=for-the-badge&logo=telegram&logoColor=white"></a>
...
<a href="https://dashboard.heroku.com/new?template=https://github.com/wahabbolteop/WahabMusic"><img src="https://img.shields.io/badge/%E2%98%81%EF%B8%8F%20Deploy%20On%20Heroku-6567a5?style=flat-square&logo=heroku&logoColor=white" height="34"></a>
<a href="https://render.com/deploy?repo=https://github.com/wahabbolteop/WahabMusic"><img src="https://img.shields.io/badge/%F0%9F%8C%90%20Deploy%20On%20Render-46e3b7?style=flat-square&logo=render&logoColor=black" height="34"></a>
...
**Wahab Music** is a next-generation voice-chat music player for Telegram groups. It streams audio & video directly into group calls using a fleet of **assistant accounts** (userbot sessions), backed by a hardened YouTube extraction pipeline:

> 🧲 **PO Token minting** · 🍪 **Cookie auth** · 🌐 **WARP proxy routing** · ♻️ **Multi-layer fallbacks**

No half-measures: when YouTube blocks one extraction path, Wahab silently falls through four more until the music plays.
...
### ⚔️ How Wahab Stacks Up

| Capability | ⚡ Wahab Music | Typical Yukki fork | Plain pytgcalls bot |
|:-----------|:--------------:|:------------------:|:-------------------:|
...
git clone https://github.com/wahabbolteop/WahabMusic && cd WahabMusic
...
<a href="https://dashboard.heroku.com/new?template=https://github.com/wahabbolteop/WahabMusic"><img src="https://img.shields.io/badge/%E2%98%81%EF%B8%8F%20Deploy%20On%20Heroku-6567a5?style=for-the-badge&logo=heroku&logoColor=white" width="230" height="40"></a>

One click → fill vars → deploy. Worker dyno included via `heroku.yml`.

### 🌐 Deploy on Render

<a href="https://render.com/deploy?repo=https://github.com/wahabbolteop/WahabMusic"><img src="https://img.shields.io/badge/%F0%9F%8C%90%20Deploy%20On%20Render-46e3b7?style=for-the-badge&logo=render&logoColor=black" width="230" height="40"></a>
...
docker build -t wahabmusic .
docker run -d --name wahabmusic \
  --env-file .env \
...
Create `/etc/systemd/system/wahabmusic.service`:
```ini
[Unit]
Description=WahabMusic Telegram Music Bot
...
WorkingDirectory=/home/ubuntu/WahabMusic
ExecStart=/usr/bin/python3 -u -m WahabX
Restart=always
RestartSec=5
LimitNOFILE=1048576
StandardOutput=append:/home/ubuntu/WahabMusic/bot.log
StandardError=append:/home/ubuntu/WahabMusic/bot.log
...
sudo systemctl enable --now wahabmusic   # start now + on boot
systemctl status wahabmusic              # health check
tail -f ~/WahabMusic/bot.log             # live logs
sudo systemctl restart wahabmusic        # apply .env/code changes
```
...
WahabMusic ships with the **[`yt-dlp-getpot-wpc`](https://github.com/coletdjnz/yt-dlp-getpot-wpc)** PO Token provider (already in `requirements.txt`). It launches a real browser in the background to mint PO Tokens that bypass this check. All you must supply is a Chrome/Chromium binary.
...
Then restart the bot (`sudo systemctl restart wahabmusic` — or however you run yours).
...
Usually caused by playing a **direct googlevideo URL that is IP-bound** to another exit point (e.g. fetched through a proxy). With `PROXY_URL` set, Wahab auto-forces download-first playback which sidesteps this entirely. Also verify: assistant isn't muted in Telegram, and device output isn't routed elsewhere.
</details>
...
systemd: `sudo systemctl restart wahabmusic` · tmux: detach and rerun `bash start` · Docker: `docker restart wahabmusic`.
</details>
...
<img src="https://github-profile-trophy.vercel.app/?username=wahabbolteop&theme=tokyonight&no-frame=true&no-bg=true&row=1&column=7&margin-w=8" width="100%" alt="Trophies"/>
...
<img src="https://github-readme-stats.vercel.app/api?username=wahabbolteop&show_icons=true&theme=tokyonight&hide_border=true&bg_color=0d1117&title_color=7dff00&icon_color=a855f7" width="100%" alt="GitHub stats"/>

</td>
<td width="50%">

<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=wahabbolteop&layout=compact&theme=tokyonight&hide_border=true&bg_color=0d1117&title_color=7dff00&langs_count=6" width="100%" alt="Top languages"/>
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=wahabbolteop&theme=tokyo-night&hide_border=true&bg_color=0d1117&color=7dff00&line=a855f7&point=22d3ee&area=true&area_color=a855f7" width="100%" alt="Activity graph"/>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/wahabbolteop/WahabMusic/output/github-contribution-grid-snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/wahabbolteop/WahabMusic/output/github-contribution-grid-snake.svg" />
  <img alt="Contribution snake animation" src="https://raw.githubusercontent.com/wahabbolteop/WahabMusic/output/github-contribution-grid-snake-dark.svg" width="100%"/>
</picture>
...
- 👥 **Support Group:** [Join here](https://t.me/wahab_chatting)
...
**Wahab Music** — *Built with 🖤 by ll_dark_poison_ll*

<br>

<a href="https://github.com/wahabbolteop/WahabMusic"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=18&pause=1200&color=A855F7&center=true&vCenter=true&width=560&lines=Thanks+for+visiting+%F0%9F%92%9C;Star+the+repo+if+it+rocked+your+VC+%E2%AD%90;Report+bugs+in+Issues+%2B+join+Support+Group" alt="Typing SVG"/></a>
...
<a href="https://github.com/wahabbolteop/WahabMusic/stargazers"><img src="https://img.shields.io/github/stars/wahabbolteop/WahabMusic?color=facc15&logo=github&logoColor=facc15&style=social" alt="Star the repo"></a>
&nbsp;
<a href="https://github.com/wahabbolteop/WahabMusic/fork"><img src="https://img.shields.io/github/forks/wahabbolteop/WahabMusic?color=a855f7&logo=github&logoColor=a855f7&style=social" alt="Fork the repo"></a>
&nbsp;
<a href="https://github.com/wahabbolteop/WahabMusic/blob/main/LICENSE"><img src="https://img.shields.io/badge/License-MIT-blueviolet?style=flat-square" alt="MIT License"></a>
